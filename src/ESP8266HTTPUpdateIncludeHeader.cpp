...
ESP8266HTTPUpdateIncludeHeader::ESP8266HTTPUpdateIncludeHeader(void)
        : _httpClientTimeout(8000)
{
}

ESP8266HTTPUpdateIncludeHeader::ESP8266HTTPUpdateIncludeHeader(int httpClientTimeout)
 ...
 */
void ESP8266HTTPUpdateIncludeHeader::setAuthorization(const String &user, const String &password)
{
    _user = user;
    _password = password;
}
 ...
 */
void ESP8266HTTPUpdateIncludeHeader::setAuthorization(const String &auth)
{
    _auth = auth;
}

HTTPUpdateResult ESP8266HTTPUpdateIncludeHeader::update(WiFiClient& client, const String& url, const String& currentVersion)
{
    HTTPClient http;
...
HTTPUpdateResult ESP8266HTTPUpdateIncludeHeader::updateIncludeHeader(WiFiClient& client, const String& url, const String& typeHeader, const String& valueHeader, const String& currentVersion)
{
    HTTPClient http;
    http.begin(client, url);
    http.addHeader(typeHeader, valueHeader);
    return handleUpdate(http, currentVersion, false);
}

HTTPUpdateResult ESP8266HTTPUpdateIncludeHeader::updateFS(WiFiClient& client, const String& url, const String& currentVersion)
{
    HTTPClient http;
    http.begin(client, url);
...
HTTPUpdateResult ESP8266HTTPUpdateIncludeHeader::update(WiFiClient& client, const String& host, uint16_t port, const String& uri,
...
HTTPUpdateResult ESP8266HTTPUpdateIncludeHeader::update(HTTPClient& httpClient, const String& currentVersion)
{
    return handleUpdate(httpClient, currentVersion, false);
}

HTTPUpdateResult ESP8266HTTPUpdateIncludeHeader::updateFS(HTTPClient& httpClient, const String& currentVersion)
{
 ...
 */
int ESP8266HTTPUpdateIncludeHeader::getLastError(void)
{
    return _lastError;
}
 ...
 * @return String error
 */
String ESP8266HTTPUpdateIncludeHeader::getLastErrorString(void)
{
 ...
 */
HTTPUpdateResult ESP8266HTTPUpdateIncludeHeader::handleUpdate(HTTPClient& http, const String& currentVersion, bool spiffs)
{
 ...
 */
bool ESP8266HTTPUpdateIncludeHeader::runUpdate(Stream& in, uint32_t size, const String& md5, int command)
{
...
ESP8266HTTPUpdateIncludeHeader ESPHTTPUpdateIncludeHeader;
#endif
